...
According to this correaltion plot, 

1) The trip distance and fare amount is positively corelated, and so is the total amount. Its understandable as higher the distance travelled, the higher the fare amounts to.

2) Surprisingly the tip amount isn't that highly related to the fare amount, this might be because of the number of tips recorded for cash type payment is NULL.

3) The trip type is highly related to the ratecode id and the other taxes, which makes perfect sense as pointed out earlier.
